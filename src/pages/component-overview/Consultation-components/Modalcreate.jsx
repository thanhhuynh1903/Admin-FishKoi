...
export default function Modalcreate({refresh}) {
  ...
  const handleSubmit = async () => {
    try {
      const response = await apost('/consultation/create', {
        element: formData.element,
        suitableColors: formData.suitableColors.split(','), // Assuming suitableColors is a comma-separated string
        meaning: formData.meaning,
        fishPondPlacement: formData.fishPondPlacement,
  ...
  return (
    <div>
      ...
      >
        <Box sx={style}>
          <h2 style={{ textAlign: 'center', marginTop: '0px', marginBottom: '0px' }}>Create new consultation</h2>
            ...
            <Grid container spacing={2} mt={2}>
              ...
              <Grid item xs={12} sx={{ paddingTop: '0px !important' }}>
                ...
                <TextField
                  ...
                  placeholder="Write your element here"
                />
                <HelperText />
              </Grid>
              <Grid item xs={12} sx={{ paddingTop: '0px !important' }}>
              ...
              <Grid item xs={12} sx={{ paddingTop: '0px !important' }}>
                <Label>Pond Placement</Label>
                <TextField
                  sx={{ width: '100%' }}
                  name="fishPondPlacement"
                  value={formData.fishPondPlacement}
                  onChange={handleChange}
                  placeholder="Write pond placement here"
                />
                <HelperText />
              </Grid>
              <Grid item xs={12} sx={{ paddingTop: '0px !important' }}>
                ...
                <TextField
                  ...
                  onChange={handleChange}
                  placeholder="Write limitations here"
                />
                <HelperText />
              </Grid>
              <Grid item xs={12} sx={{ paddingTop: '0px !important' }}>
